...
public class MMMessageTypeUtil {
	...
	public static MMessageType1 getMsgType1(String prod, int val){
		MMessageType1 mst1 = new MMessageType1(prod, BigDecimal.valueOf(val));
		return mst1;
	}
	...
	public static MMessageType1 getProd1MsgType1(int val){
		MMessageType1 mst1 = getMsgType1(MMMessageTypeUtil.prod1, val);
		return mst1;
	}
